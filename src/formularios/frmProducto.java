...
public class frmProducto extends javax.swing.JInternalFrame {
    ...
    public void keyTypedNum2(KeyEvent ke) {
        ...
        if (Character.isLetter(c)) {
            getToolkit().beep();
            ke.consume();
            lblcod.setText("Ingresa solo Numeros");

        }

    }

    public void keyTypedNum3(KeyEvent ke) {
        char c = ke.getKeyChar();
        if (Character.isLetter(c)) {
            getToolkit().beep();
            ke.consume();
            lblcate.setText("Ingresa solo Numeros");

        }

    }

    public void keyTypedNum4(KeyEvent ke) {
        char c = ke.getKeyChar();
        if (Character.isLetter(c)) {
            getToolkit().beep();
            ke.consume();
            lblcom.setText("Ingresa solo Numeros");

        }

    }

    public void keyTypedNum5(KeyEvent ke) {
        char c = ke.getKeyChar();
        if (Character.isLetter(c)) {
            getToolkit().beep();
            ke.consume();
            lblven.setText("Ingresa solo Numeros");

        }

    }

    public void keyTypedNum6(KeyEvent ke) {
        char c = ke.getKeyChar();
        if (Character.isLetter(c)) {
            getToolkit().beep();
            ke.consume();
            lbls.setText("Ingresa solo Numeros");

        }

    }

    public void keyTypedNum7(KeyEvent ke) {
        char c = ke.getKeyChar();
        if (Character.isLetter(c)) {
            getToolkit().beep();
            ke.consume();
            lbllo.setText("Ingresa solo Numeros");
    ...
    private void initComponents() {
        ...
        lblcod = new java.awt.Label();
        lblcate = new java.awt.Label();
        lblcom = new java.awt.Label();
        lblven = new java.awt.Label();
        lbls = new java.awt.Label();
        lbllo = new java.awt.Label();
        ...
        lblcod.setFont(new java.awt.Font("Dialog", 0, 10)); // NOI18N
        jPanel1.add(lblcod, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 90, 170, -1));
        lblcod.getAccessibleContext().setAccessibleName("label1");

        lblcate.setFont(new java.awt.Font("Dialog", 0, 10)); // NOI18N
        jPanel1.add(lblcate, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 140, 170, -1));

        lblcom.setFont(new java.awt.Font("Dialog", 0, 10)); // NOI18N
        lblcom.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                lblcomKeyTyped(evt);
            }
        });
        jPanel1.add(lblcom, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 240, 180, -1));

        lblven.setFont(new java.awt.Font("Dialog", 0, 10)); // NOI18N
        jPanel1.add(lblven, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 290, 110, -1));

        lbls.setFont(new java.awt.Font("Dialog", 0, 10)); // NOI18N
        jPanel1.add(lbls, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 320, 170, -1));

        lbllo.setFont(new java.awt.Font("Dialog", 0, 10)); // NOI18N
        jPanel1.add(lbllo, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 360, 120, -1));
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        try {
            ...
            ps.setString(1, txtnomproducto.getText());
            ps.setString(2, txtcodcategoria.getText());
            ps.setString(3, txtpreciocompra.getText());
            ps.setString(4, txtprecioventa.getText());
            ps.setString(5, txtstock.getText());
            ps.setString(6, txtnumlote.getText());
            ps.setString(7, txtcodproducto.getText());
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        try {
            ...
            String sql = "SELECT id_producto,id_categoria, producto, precio_compra, precio_venta, existencia, num_lote FROM Productos " + where;
    ...
    private void lblcomKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_lblcomKeyTyped
        keyTypedNum4(evt);


    }//GEN-LAST:event_lblcomKeyTyped
    ...
    private void txtnumloteKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtnumloteKeyTyped
        keyTypedNum7(evt);
    }//GEN-LAST:event_txtnumloteKeyTyped
    ...
    private java.awt.Label lblcate;
    private java.awt.Label lblcod;
    private javax.swing.JLabel lblcodcategoria;
    private javax.swing.JLabel lblcodproducto;
    private java.awt.Label lblcom;
    private java.awt.Label lbllo;
    ...
    private java.awt.Label lbls;
    private javax.swing.JLabel lblstock;
    private java.awt.Label lblven;
