...
public class frmProveedor extends javax.swing.JInternalFrame {
    ...
    public void keyTypedNum(KeyEvent ke) {
     ...
     public void keyTypedNum2(KeyEvent ke) {
        ...
        if (Character.isLetter(c)) {
            getToolkit().beep();
            ke.consume();
            lbltele.setText("Ingresa Solo Numeros");
    ...
    private void initComponents() {
        ...
        lblpro = new java.awt.Label();
        lbltele = new java.awt.Label();
        ...
        jPanel1.add(lblcod, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 130, 220, -1));

        lblpro.setFont(new java.awt.Font("Dialog", 0, 10)); // NOI18N
        jPanel1.add(lblpro, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 190, 190, -1));

        lbltele.setFont(new java.awt.Font("Dialog", 0, 10)); // NOI18N
        jPanel1.add(lbltele, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 240, 200, -1));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        String codproveedor, nomproveedor, telefono, correo, direccion;
        String sql = "";
    ...
    private void JProductosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JProductosMouseClicked
        ...
        int rec = this.JProductos.getSelectedRow();
        this.txtcodproveedor.setText(JProductos.getValueAt(rec, 0).toString());
        this.txtnomproveedor.setText(JProductos.getValueAt(rec, 1).toString());
        this.txttlelefono.setText(JProductos.getValueAt(rec, 2).toString());
        this.txtcorreo.setText(JProductos.getValueAt(rec, 3).toString());
        this.txtdireccion.setText(JProductos.getValueAt(rec, 4).toString());
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        try {
            ...
            ps.setString(1, txtnomproveedor.getText());
            ps.setString(2, txttlelefono.getText());
            ps.setString(3, txtcorreo.getText());
            ps.setString(4, txtdireccion.getText());
            ps.setString(5, txtcodproveedor.getText());
            ...
            JOptionPane.showMessageDialog(null, "ERROR AL REGISTRO PRODUCTO...");
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        try {
            ...
            String sql = "SELECT id_proveedor,proveedor, telefono, correo, direccion FROM Proveedores " + where;
    ...
    private java.awt.Label lblpro;
    private javax.swing.JLabel lblproveedor;
    private java.awt.Label lbltele;
